...
When working from a local checkout of the ZEN-temple repository, install ZEN-temple in the same environment
with ``pip install -e .`` from the ZEN-temple repository.
