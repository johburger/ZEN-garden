...
class ConversionTechnologyRules(GenericRule):
    ...
    def constraint_opex_emissions_technology_conversion(self):
        """Calculate opex and carbon emissions of technologies and additional impacts
        ...
        technology :math:`h` \n
        :math:`\\kappa_{h,p,t}^{impact}`: emissions of category `impact' of operating
        the technology :math:`h` at node :math:`p` in time step :math:`t` \n
        :math:`\\epsilon_h^{impact}`: intensity of category `impact' of the reference
        carrier of technology :math:`h` \n
