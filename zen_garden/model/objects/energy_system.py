...
class EnergySystem:
    ...
    def store_input_data(self):
        ...
        if self.system["include_carbon_emissions_annual_limit_adjustment"]:
            self.carbon_emissions_annual_limit_adjustment = self.data_input.extract_input_data(
                "carbon_emissions_annual_limit_adjustment", index_sets=["set_time_steps_yearly"],
                time_steps="set_time_steps_yearly", unit_category={'emissions': 1})
            ...
            self.carbon_emissions_annual_limit_adjustment_factor = self.data_input.extract_input_data(
                "carbon_emissions_annual_limit_adjustment_factor", index_sets=[], unit_category={})
