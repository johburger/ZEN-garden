...
class DataInput:
    ...
    def extract_input_data(self, file_name, index_sets, unit_category, time_steps=None, subelement=None):
        ...
        # use distances computed with node coordinates as default values
            ...
            df_output, default_value, index_name_list = self.create_default_output(index_sets, unit_category, file_name=file_name, time_steps=time_steps, manual_default_value=1)
        else:
